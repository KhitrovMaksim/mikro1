...
export class Migration20260115084546 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`user\` (\`id\` integer not null primary key autoincrement, \`created_at\` datetime not null, \`updated_at\` datetime not null, \`full_name\` text not null, \`email\` text not null, \`password\` text not null, \`bio\` text not null default '', \`social\` json null);`);
